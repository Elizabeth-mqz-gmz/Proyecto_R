...
par(mfrow = c(2,2))
pie(c(deadsPerComorbidity[1], alivePerComorbidity[1]), labels = labs, main = 'Mortalidad de Obesos', col = )
pie(c(deadsPerComorbidity[2], alivePerComorbidity[2]), labels = labs, main = 'Mortalidad de Diabetes', col = color)
pie(c(deadsPerComorbidity[3], alivePerComorbidity[3]), labels = labs, main = 'Mortalidad de Neumonia', col = color)
pie(c(deadsPerComorbidity[4], alivePerComorbidity[4]), labels = labs, main = 'Mortalidad de Tabaquismo', col = color)
